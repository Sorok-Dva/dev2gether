!(function (a) {
  a.fn.countdown = function (b) {
    function k () {
      var a = new Date(),
        b = h - a;
      b = Math.floor(b / 1e3), b < 1 && (b = 0), i || b == 0 && (i = !0, j.onComplete());
      ...
      var n = Math.floor(b);
      if (j.show_second && f.children('.counter').text(n), j.progress != 0) {
